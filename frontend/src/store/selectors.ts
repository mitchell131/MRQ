...
export const selectPriceHistory = (state: TAppState) =>
  state.priceHistory.history;
export const selectChartIsLoading = (state: TAppState) =>
  state.priceHistory.apiState.loading;
export const selectChartIsError = (state: TAppState) =>
  state.priceHistory.apiState.error;
// Stocks Slice
...
export const selectStocksIsLoading = (state: TAppState) =>
  state.stocks.apiState.loading;
export const selectStocksIsError = (state: TAppState) =>
  state.stocks.apiState.error;
// Price Slice
